...
\lstset{basicstyle=\ttfamily\fontsize{11}{10}\selectfont}  
\lstset{tabsize=2}
\lstset{keywordstyle=\bf\color{blue}, commentstyle=\color{Comments},stringstyle=\color{mauve}}
...
\begin{document}
    ...
    \setcounter{page}{2}   % номер первой страницы
