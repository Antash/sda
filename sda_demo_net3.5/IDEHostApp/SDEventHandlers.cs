...
namespace SharpDevelopIDEHost
{
    ...
    /// If there are compilation errors, notify ITM about this fact.
    /// Otherwise, attaches SDA debugger to zebCtlNt.exe and notify ITM about successfull add-in build.
    /// </summary>
	class ExecuteHandler : Execute
	{
		public ExecuteHandler()
		{
			Console.WriteLine("Debug object created at " + DateTime.Now.ToLongTimeString());
		}
    ...
    /// Pos-Build action.
    /// 
    /// Notifies ITM about successfull\unsuccessfull build.
    /// </summary>
	...
	public class OpenSDAProjectHandler : AbstractCommand
	{
		public override void Run()
		{
			if (SDIntegration.Instance.ReadyToInvokeDialogs())
